...
public class StockpileProtocolTest {
   ...
   void fullSequenceReachesAcknowledged() {
      ...
      Assertions.assertTrue(p.accept(StockpileProtocol.Signal.FLOWER_OPEN));
      Assertions.assertTrue(p.accept(StockpileProtocol.Signal.FLOWER_SELECTED));
   ...
   void timeoutFailsClosed() {
      ...
      Assertions.assertFalse(p.accept(StockpileProtocol.Signal.FLOWER_OPEN));
   }
   ...
   void acknowledgedRejectsFurtherSignals() {
      ...
      p.accept(StockpileProtocol.Signal.FLOWER_OPEN);
      p.accept(StockpileProtocol.Signal.FLOWER_SELECTED);
      p.placeSent();
   ...
   @Test
   void placeSentRequiresFlowerSelected() {
      StockpileProtocol p = new StockpileProtocol();
