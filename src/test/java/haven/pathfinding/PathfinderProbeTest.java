...
public class PathfinderProbeTest {
   ...
   void edgeDistanceIsZeroInsideAndOnBoundary() {
      ...
      Assertions.assertTrue(MovementScene.pointInside(Coord2d.of(5.0, 5.0), box));
      Assertions.assertEquals(0.0, MovementScene.minPolyDist(Coord2d.of(5.0, 5.0), List.<Coord2d[]>of(box)), 1.0E-9);
      Assertions.assertEquals(0.0, MovementScene.edgeDistance(Coord2d.of(0.0, 5.0), box), 1.0E-9);
      Assertions.assertEquals(3.0, MovementScene.edgeDistance(Coord2d.of(-3.0, 5.0), box), 1.0E-9);
   }
   ...
   void occupancyMarks032TileStandFreeAfterOverlapRaster() {
      ...
      MovementScene.rasterPolygon(solid, origin, w, h, box, MovementScene.OVERLAP);
      boolean[] dilated = Arrays.copyOf(solid, solid.length);
      MovementScene.dilate(dilated, w, h, 1);
