...
class InteractionTargetTest {
   private static MovementScene.GobGeom gob(long id, String resid, Coord2d rc, boolean caveTransition) {
   ...
   private static MovementScene.Scene scene(MovementScene.GobGeom... gobs) {
      MovementScene.Scene s = new MovementScene.Scene();
   ...
   void resolvesSameGobById() {
      MovementScene.GobGeom live = gob(1844735939L, "gfx/terobjs/arch/cellardoor", Coord2d.of(-10466.5, -10411.5), true);
      InteractionTarget t = InteractionTarget.of(live, "transition:CELLAR_STAIRS", "state_changed", "");
      MovementScene.GobGeom found = t.resolveIn(scene(gob(1L, "gfx/terobjs/studydesk", Coord2d.of(0.0, 0.0), false), live));
   ...
   void idChangeAfterReloadResolvesByStableIdentity() {
      InteractionTarget t = cellarDoor(1844735939L, Coord2d.of(-10466.5, -10411.5));
      MovementScene.GobGeom reloaded = gob(990001L, "gfx/terobjs/arch/cellardoor", Coord2d.of(-10466.0, -10411.0), true);
      MovementScene.GobGeom found = t.resolveIn(scene(reloaded));
   ...
   void differentResourceAtSameLocationIsRejected() {
      InteractionTarget t = cellarDoor(1844735939L, Coord2d.of(-10466.5, -10411.5));
      MovementScene.GobGeom other = gob(990002L, "gfx/terobjs/arch/polegate", Coord2d.of(-10466.0, -10411.0), true);
   ...
   void sameResourceFarAwayIsRejected() {
      InteractionTarget t = cellarDoor(1844735939L, Coord2d.of(-10466.5, -10411.5));
      MovementScene.GobGeom distant = gob(990003L, "gfx/terobjs/arch/cellardoor", Coord2d.of(-10000.0, -10000.0), false);
   ...
   void classificationMismatchFailsCompatibility() {
      InteractionTarget t = cellarDoor(1844735939L, Coord2d.of(-10466.5, -10411.5));
      MovementScene.GobGeom unclassified = gob(990004L, "gfx/terobjs/arch/cellardoor", Coord2d.of(-10466.0, -10411.0), false);
   ...
   void emptySceneYieldsTargetDisappeared() {
      ...
      List<MovementScene.GobGeom> empty = new ArrayList<MovementScene.GobGeom>();
