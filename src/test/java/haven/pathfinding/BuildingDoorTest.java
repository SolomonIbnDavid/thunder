...
public class BuildingDoorTest {
   ...
   void stoneMansionTargetIsTheDoorNotTheHull() {
      ...
      BuildingDoor.Target t = BuildingDoor.target("gfx/terobjs/arch/stonemansion", hull, 0.0, 9L, hull.add(48.0, 0.0));
      Assertions.assertNotNull(t);
      Assertions.assertEquals(148.0, t.origin.x, 1.0E-6);
      Assertions.assertEquals(200.0, t.origin.y, 1.0E-6);
      ...
      g.obst = obst;
      haven.nav.InteractionSpec spec = InteractionAdapter.fromGob(
         g, haven.nav.InteractionSpec.ALL_SIDES, 1.0, 35.0, 1, null, InteractionVerifier.STATE_CHANGED, hull.add(48.0, 0.0)
      );
