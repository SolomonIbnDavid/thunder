 ...
 * Esc), and uses BotMovement for every walk so
...
public class FishSpitRoastBot {
    ...
    private static final class Run {
        ...
        private List<Gob> gobsIn(Area area) {
            ...
            return WorldObjectRegistry.snapshot(gui, player, 0).objects.stream()
                .filter(e -> area.contains(e.position.floor(MCache.tilesz)))
                .map(e -> e.gob)
