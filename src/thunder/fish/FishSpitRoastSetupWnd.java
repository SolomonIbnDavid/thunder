 ...
 *
 * Reuses thunder.mining.ZonePicker but performs per-role cleanup only, so
...
public class FishSpitRoastSetupWnd extends WindowX {
    ...
    static {
        ZonePicker.registerRoleColor(FishSpitRoastZoneStore.ROLE_INPUT, RGB_INPUT);
        ZonePicker.registerRoleColor(FishSpitRoastZoneStore.ROLE_FIRE, RGB_FIRE);
        ZonePicker.registerRoleColor(FishSpitRoastZoneStore.ROLE_OUTPUT, RGB_OUTPUT);
    }
    ...
    public void destroy() {
        ...
        ZonePicker.hideZone(FishSpitRoastZoneStore.ROLE_INPUT);
        ZonePicker.hideZone(FishSpitRoastZoneStore.ROLE_FIRE);
        ZonePicker.hideZone(FishSpitRoastZoneStore.ROLE_OUTPUT);
