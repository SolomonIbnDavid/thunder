...
//    public static final CFG<Boolean> DISPLAY_KINNAMES = new CFG<>("display.kinnames", true);
    ...
    public static final CFG<Boolean> DISPLAY_GOB_INFO = new CFG<>("display.gob_info", true);
    ...
    public static final CFG<Set<GobInfoOpts.TreeSubPart>> DISPLAY_GOB_INFO_TREE_ENABLED_PARTS = new CFG<>("display.gob_info_tree_enabled_parts", new HashSet<>(Arrays.asList(GobInfoOpts.TreeSubPart.SEEDS, GobInfoOpts.TreeSubPart.LEAVES, GobInfoOpts.TreeSubPart.BARK, GobInfoOpts.TreeSubPart.BOUGH)), new TypeToken<Set<GobInfoOpts.TreeSubPart>>(){});
    ...
    public static final CFG<Boolean> DISPLAY_RIDGE_BOX = new CFG<>("display.ridge_box", true);
    public static final CFG<Boolean> COLORIZE_DEEP_WATER = new CFG<>("display.colored_deep_water", true);
    public static final CFG<Integer> DISPLAY_SCALE_CUPBOARDS = new CFG<>("display.scale.cupboards", 40);
    public static final CFG<Integer> DISPLAY_SCALE_WALLS = new CFG<>("display.scale.walls", 100);
    public static final CFG<Boolean> DISPLAY_DECALS_ON_TOP = new CFG<>("display.decals_on_top", true);
    public static final CFG<Boolean> DISPLAY_NO_MAT_CUPBOARDS = new CFG<>("display.no_mat.cupboards", false);
    public static final CFG<Boolean> DISPLAY_AURA_SPEED_BUFF = new CFG<>("display.aura.speed", true);
    ...
    public static final CFG<Boolean> DISABLE_ACTION_HOTKEYS = new CFG<>("ui.disable_action_hotkeys", false);
    public static final CFG<Boolean> FLOATING_HUD = new CFG<>("ui.floating_hud", false);
    ...
    public static final CFG<Boolean> UI_SHOW_EQPROXY_POUCH = new CFG<>("ui.eq_proxy.pouch", true);
    ...
    public static final CFG<Boolean> HIGHLIGHT_PARTY_IN_COMBAT = new CFG<>("ui.combat.highlight_party_in_combat", true);
    public static final CFG<Boolean> HIGHLIGHT_SELF_IN_COMBAT = new CFG<>("ui.combat.highlight_self_in_combat", false);
    public static final CFG<Boolean> HIGHLIGHT_ENEMY_IN_COMBAT = new CFG<>("ui.combat.highlight_enemies_in_combat", true);
    ...
    public static final CFG<Boolean> MMAP_DEBUG = new CFG<>("ui.mmap_debug", false);
    ...
    public static final CFG<Boolean> MMAP_SHOW_PCLAIM = new CFG<>("ui.mmap_pclaim", false);
    public static final CFG<Boolean> MMAP_SHOW_VCLAIM = new CFG<>("ui.mmap_vclaim", false);
    ...
    public static final CFG<Boolean> WARN_STARVATION = new CFG<>("general.warn_starvation", true);
    public static final CFG<Boolean> REAL_TIME_CURIO = new CFG<>("ui.real_time_curio", true);
    public static final CFG<Boolean> SHOW_CURIO_LPH = new CFG<>("ui.show_curio_lph", true);
    public static final CFG<Boolean> SHOW_CURIO_REMAINING_TT = new CFG<>("ui.show_curio_remaining_tt", true);
    public static final CFG<Boolean> SHOW_CURIO_REMAINING_METER = new CFG<>("ui.show_curio_remaining_meter", true);
    public static final CFG<Boolean> IMPROVE_DAMAGE_TIP = new CFG<>("ui.improve_damage_tip", true);
    ...
    public static final CFG<Boolean> AUTO_DRINK_ENABLED = new CFG<>("automation.autodrink.enabled", true);
    ...
    public static final CFG<Boolean> HARDWARE_CURSOR = new CFG<>("ui.hardware_cursor", true);
